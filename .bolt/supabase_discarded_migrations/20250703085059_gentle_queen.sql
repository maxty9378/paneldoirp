...
1. Функции
   - Исправлены сигнатуры функций для предотвращения конфликтов
   - Изменены все DROP FUNCTION с указанием полных сигнатур
   - Переименована функция rpc_create_user_v2 в rpc_create_user_v3 для избежания конфликтов

2. Триггеры
   - Исправлена функция и триггер для создания пользователей

3. Права
   - Обновлены права на выполнение функций
*/
...
-- Создаем новую функцию с другим именем, чтобы избежать конфликта
...
-- Исправляем триггерную функцию
DROP FUNCTION IF EXISTS after_user_created_in_users();
