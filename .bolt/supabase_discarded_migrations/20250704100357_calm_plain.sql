/*
  # Управление последовательностью доступных тестов

  1. Изменения в функциях
    - Обновляем функцию auto_assign_tests_to_participant для последовательной доступности тестов
    - Обновляем логику проверки прохождения предыдущих тестов
    
  2. Новые функции
    - Добавляем функцию check_and_assign_annual_test для создания годовых тестов
    
  3. Тестовые данные
    - Добавляем данные для проверки работоспособности
*/
