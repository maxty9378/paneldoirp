/*
  ...
  1. Новые таблицы
    ...
    - user_activity_logs - обновленные логи активности пользователей
    - notification_tasks - задачи и уведомления

  2. Расширения существующих таблиц
    - Добавление новых полей в users
    - Добавление новых полей в territories и positions
...
-- Вставляем базовые системные настройки
INSERT INTO system_settings (key, value, description, category) VALUES
  ('email_notifications', 'true', 'Включить email уведомления', 'notifications'),
  ('max_file_size_mb', '10', 'Максимальный размер файла в МБ', 'uploads'),
  ('session_timeout_minutes', '60', 'Время сессии в минутах', 'security'),
  ('maintenance_mode', 'false', 'Режим обслуживания', 'system'),
  ('auto_backup', 'true', 'Автоматическое резервное копирование', 'system'),
  ('default_user_role', 'employee', 'Роль пользователя по умолчанию', 'users'),
  ('password_min_length', '6', 'Минимальная длина пароля', 'security'),
  ('login_attempts_limit', '5', 'Максимальное количество попыток входа', 'security')
