...
export function TestUsersView() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      // Используем специальную функцию для тестового просмотра
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-yellow-800 space-y-1 list-disc list-inside">
          <li>Эта страница использует специальную функцию <code className="bg-yellow-100 px-1 rounded">get_test_users()</code> для безопасного просмотра данных</li>
          <li>Функция доступна публично и не зависит от RLS политик таблицы <code className="bg-yellow-100 px-1 rounded">users</code></li>
          <li>Если вы видите список пользователей — значит функция работает корректно</li>
          <li>Эта страница доступна без авторизации для тестирования</li>
