...
export function LoginPage({ onSuccess }: LoginPageProps) {
  return (
    <div className="fixed inset-0 overflow-hidden bg-gradient-to-br from-[#f4fff9] via-white to-[#e6f7f1]">
      ...
      {/* Легкая текстура */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_60%_40%,rgba(6,164,120,0.12),transparent_55%)] pointer-events-none" />
