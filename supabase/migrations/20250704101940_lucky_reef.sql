/*
# Исправление SQL функций для работы с тестами

1. Новые функции
  - Исправлены объявления переменных цикла в функции check_annual_test_eligibility()
  - Обновлена функция auto_assign_tests_to_participant для назначения тестов в правильной последовательности
  
2. Изменения
  - Исправлены ошибки синтаксиса в циклах PL/pgSQL
  - Добавлены проверки для последовательного прохождения тестов

3. Безопасность
  - Все функции работают с правами SECURITY DEFINER для обхода RLS
*/
